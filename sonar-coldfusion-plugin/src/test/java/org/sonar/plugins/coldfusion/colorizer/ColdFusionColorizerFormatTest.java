 ...
 */
package org.sonar.plugins.coldfusion.colorizer;
...
public class ColdFusionColorizerFormatTest {

  @Test
  public void testGetTokenizers() {
    List<Tokenizer> list = (new ColdFusionColorizerFormat()).getTokenizers();
