...
import org.sonar.coldfusion.metrics.FileLinesVisitor;
...
public class ColdFusionSquidSensor implements Sensor {
  ...
  private CFConfiguration createConfiguration(Project project) {
    return new CFConfiguration(project.getFileSystem().getSourceCharset());
  }
