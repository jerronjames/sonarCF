 ...
 */
package org.sonar.coldfusion.toolkit;
...
public class ColdFusionConfigurationModel extends AbstractConfigurationModel {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(ColdFusionConfigurationModel.class);
  ...
  @VisibleForTesting
  CFConfiguration getConfiguration() {
    return new CFConfiguration(getCharset());
  }
