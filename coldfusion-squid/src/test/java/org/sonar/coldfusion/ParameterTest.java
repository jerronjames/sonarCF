...
public class ParameterTest {
  ...
  @Test
  public void ok() {
    assertThat(g.rule(CFGrammar.PARAMETER))
        .matches("required parameterType identifier = 1")
        .matches("parameterType identifier = 2")
        .matches("identifier = 3")
        .matches("identifier")
        .matches("required parameterType identifier")
        .matches("required identifier");
  }
}
