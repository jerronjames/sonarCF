...
public class PowerOfExpressionTest {
  ...
  @Test
  public void ok() {
    assertThat(g.rule(CFGrammar.POWER_OF_EXPRESSION))
    	.matches("unaryExpression ^ unaryExpression2")
    	.matches("unaryExpression++ ^ 2")
    	.matches("--unaryExpression ^ 3++");
  }
}
